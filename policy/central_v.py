...
class CentralV:
    ...
    def save_model(self, train_step, episode_counts):
        ...
        torch.save(self.eval_critic.state_dict(), f"{self.model_dir}/{num}({episode_counts})_critic_params.pkl")
        torch.save(self.eval_rnn.state_dict(), f"{self.model_dir}/{num}({episode_counts})_rnn_params.pkl")
