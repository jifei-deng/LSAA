...
class QtranAlt:
    def __init__(self, args):
        ...
        self.eval_joint_q = QtranQAlt(args)
    ...
    def save_model(self, train_step, episode_counts):
        ...
        torch.save(self.eval_joint_q.state_dict(), f"{self.model_dir}/{num}({episode_counts})_joint_q_params.pkl")
        torch.save(self.v.state_dict(), f"{self.model_dir}/{num}({episode_counts})_v_params.pkl")
