...
from clean_up.map_env import MapEnv, ACTIONS
from clean_up.agent import CleanupAgent
    ...
    def setup_agents(self):
        ...
        for i in range(self.num_agents):
            ...
            agent = CleanupAgent(agent_id, spawn_point, rotation, map_with_agents,
                                 ...
                                 view_len=self.view_size, config=self.config)
    ...
    def spawn_apples_and_waste(self):
        ...
        for i in range(len(self.apple_points)):
            ...
            if [row, col] not in self.agent_pos and self.world_map[row, col] != 'A':
                rand_num = self.np_random.random(1)[0]
